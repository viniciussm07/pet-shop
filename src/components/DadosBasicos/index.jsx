...
const Dados = () => {
    ...
    return (<>
        ...
        <form action="/" method='POST' onSubmit={updateHandler}>
            <div>
                <h3><FontBold>Dados Básicos</FontBold></h3><br/>
                ...
                <label>CPF*</label>
                <Input type="number" placeholder={cpf} name="cpf" maxLength="11" required disabled/><br/>
                <label>Data de nascimento</label>
                <Input type="date" placeholder={dateNasc} name="date-nasc"  value={dateNasc} onChange={e => setDateNasc(e.target.value)} disabled/><br/>
                <label>Telefone Celular</label>
                <Input type="text" placeholder={celular} name="telefonecel" value={celular} onChange={e => setCelular(e.target.value)}/><br/>
                <label>Telefone Contato</label>
                <Input type="text" placeholder={telefone} name="telefonecont" value={telefone} onChange={e => setTelefone(e.target.value)}/><br/>
